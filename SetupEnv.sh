...
export HCPPIPEDIR_PostFS=$(dirname $(readlink -f "${BASH_SOURCE[0]}"))"/app/HCPmod/scripts"
export HCPPIPEDIR_fMRISurf=$(dirname $(readlink -f "${BASH_SOURCE[0]}"))"/app/HCPmod/scripts"
...
# binary dependencies
export ANTSPATH=/home/exacloud/lustre1/fnl_lab/code/external/utilities/ants
export C3DPATH=/home/exacloud/lustre1/fnl_lab/code/external/utilities/c3d-1.0.0/bin # decided against 1.1.0 because the docker image uses 1.0.0 and for our purposes is the same
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${MCRROOT}/runtime/glnxa64:${MCRROOT}/bin/glnxa64:${MCRROOT}/sys/os/glnxa64:/home/exacloud/lustre1/fnl_lab/code/external/utilities/lib64/
